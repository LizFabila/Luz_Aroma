                ...
                <div class="card">
                    <div class="card-header" style="background: rgba(255,51,153,.05);">
                        <h3 class="text-center" style="color: #333; font-size: 2.5rem; margin: 1rem 0;">
                            Registrar <span style="color: #e84393;">Nuevo Costo</span>
                        </h3>
                    </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('costos.store') }}" method="POST">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <button type="submit" class="btn btn-light" style="border: 2px solid #e84393; background-color: rgba(246,170,208,0.39); color: #000000;">Registrar Costo</button>
                            </div>
                        </form>
                    </div>
                </div>
