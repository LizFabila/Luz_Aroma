                ...
                <div class="card">
                    <div class="card-header" style="background: rgba(255,51,153,.05);">
                        <h3 class="text-center" style="color: #333; font-size: 2.5rem; margin: 1rem 0;">
                            Editar <span style="color: #e84393;">Producto</span>
                        </h3>
                    </div>
                        ...
                        <form action="{{ route('productos.update', $producto->id_producto) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="nombre_producto" class="form-control @error('nombre_producto') is-invalid @enderror"
                                       value="{{ old('nombre_producto', $producto->nombre_producto) }}" required maxlength="100">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="descripcion" class="form-control @error('descripcion') is-invalid @enderror"
                                          rows="3" maxlength="255">{{ old('descripcion', $producto->descripcion) }}</textarea>
                                @error('descripcion')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="fragancia" class="form-control @error('fragancia') is-invalid @enderror"
                                       value="{{ old('fragancia', $producto->fragancia) }}" maxlength="100">
                                @error('fragancia')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number" name="stock_min" class="form-control @error('stock_min') is-invalid @enderror"
                                           value="{{ old('stock_min', $producto->stock_min) }}" min="0">
                                    @error('stock_min')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number" name="stock_max" class="form-control @error('stock_max') is-invalid @enderror"
                                           value="{{ old('stock_max', $producto->stock_max) }}" min="0">
                                    @error('stock_max')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number" name="existencias" class="form-control @error('existencias') is-invalid @enderror"
                                           value="{{ old('existencias', $producto->existencias) }}" min="0">
                                    @error('existencias')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
