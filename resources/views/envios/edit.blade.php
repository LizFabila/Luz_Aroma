                ...
                <div class="card">
                    <div class="card-header" style="background: rgba(255,51,153,.05);">
                        <h3 class="text-center" style="color: #333; font-size: 2.5rem; margin: 1rem 0;">
                            Editar <span style="color: #e84393;">Envío</span>
                        </h3>
                    </div>

                    <div class="card-body">
                        <form action="{{ route('envios.update', $envio->id_envio) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" name="fecha_envio" class="form-control @error('fecha_envio') is-invalid @enderror"
                                       value="{{ old('fecha_envio', $envio->fecha_envio ? $envio->fecha_envio->format('Y-m-d') : '') }}">
                                @error('fecha_envio')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="estado_paquete" class="form-select @error('estado_paquete') is-invalid @enderror">
                                    ...
                                    <option value="En preparación" {{ old('estado_paquete', $envio->estado_paquete) == 'En preparación' ? 'selected' : '' }}>En preparación</option>
                                    <option value="En tránsito" {{ old('estado_paquete', $envio->estado_paquete) == 'En tránsito' ? 'selected' : '' }}>En tránsito</option>
                                    <option value="En reparto" {{ old('estado_paquete', $envio->estado_paquete) == 'En reparto' ? 'selected' : '' }}>En reparto</option>
                                    <option value="Entregado" {{ old('estado_paquete', $envio->estado_paquete) == 'Entregado' ? 'selected' : '' }}>Entregado</option>
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="id_pedido" class="form-select @error('id_pedido') is-invalid @enderror">
                                    ...
                                    @foreach($pedidos as $pedido)
                                        <option value="{{ $pedido->id_pedido }}" {{ old('id_pedido', $envio->id_pedido) == $pedido->id_pedido ? 'selected' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="id_costo_envio" class="form-select @error('id_costo_envio') is-invalid @enderror">
                                    ...
                                    @foreach($costos as $costo)
                                        <option value="{{ $costo->id_costo_envio }}" {{ old('id_costo_envio', $envio->id_costo_envio) == $costo->id_costo_envio ? 'selected' : '' }}>
