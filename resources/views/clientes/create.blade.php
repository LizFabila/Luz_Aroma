                ...
                <div class="card">
                    <div class="card-header" style="background: rgba(255,51,153,.05);">
                        <h3 class="text-center" style="color: #333; font-size: 2.5rem; margin: 1rem 0;">
                            Registrar <span style="color: #e84393;">Nuevo Cliente</span>
                        </h3>
                    </div>
                        ...
                        <form action="{{ route('clientes.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="direccion_envio" class="form-control @error('direccion_envio') is-invalid @enderror"
                                          rows="3" required maxlength="255">{{ old('direccion_envio') }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" name="correo_electronico" class="form-control @error('correo_electronico') is-invalid @enderror"
                                       value="{{ old('correo_electronico') }}" required maxlength="100">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <button type="submit" class="btn btn-light" style="border: 2px solid #e84393; background-color: rgba(246,170,208,0.39); color: #000000;">Registrar Cliente</button>
                            </div>
                        </form>
                    </div>
                </div>
